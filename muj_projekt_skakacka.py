...
spiky = [
    ...
    [(700, 412), (750, 412), (725, 365)],  # Trojúhelník 2
    [(1005, 412), (1055, 412), (1030, 365)],  # Trojúhelník 1
    [(1055, 412), (1105, 412), (1080, 365)],  # Trojúhelník 2
    [(1105, 412), (1155, 412), (1130, 365)],  # Trojúhelník 3
    [(1155, 412), (1205, 412), (1180, 365)],  # Trojúhelník 4
    [(1205, 412), (1255, 412), (1230, 365)],  # Trojúhelník 5
    [(1255, 412), (1305, 412), (1280, 365)],  # Trojúhelník 6
    [(1305, 412), (1355, 412), (1330, 365)],  # Trojúhelník 7
    [(1355, 412), (1405, 412), (1380, 365)],  # Trojúhelník 8
    [(1405, 412), (1455, 412), (1430, 365)],  # Trojúhelník 9
    [(1455, 412), (1505, 412), (1480, 365)],  # Trojúhelník 10
    [(1505, 412), (1555, 412), (1530, 365)],  # Trojúhelník 11
    [(1555, 412), (1605, 412), (1580, 365)],  # Trojúhelník 12
]
